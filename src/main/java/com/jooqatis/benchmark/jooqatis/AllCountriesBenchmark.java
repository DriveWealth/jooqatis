...
/**
 * <p>Title: AllCountriesBenchmark</p>
 * <p>Description:  </p>
 * <p>Author: nwhitehead (at) drivewealth dot it</p>
 * <p><code>com.jooqatis.benchmark.jooqatis.AllCountriesBenchmark</code></p>
 */
@Service
public class AllCountriesBenchmark extends AbstractBenchmark {
	 ...
	 */
	public AllCountriesBenchmark(
		MeterRegistry meterRegistry,
		JooqCountryService jooqCountryService,
		CountryService myBatisCountryService, 
		ExecutorService executorService		
		) {
		super(() -> jooqCountryService.getCountryList().size(), () -> myBatisCountryService.getCountryList().size(), meterRegistry, executorService);
	}
